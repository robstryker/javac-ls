 ...
 * technology reusing the compiler. With the introduction of <code>shaded.org.eclipse.jdt.core.compiler.CompilationParticipant</code>,
 ...
 * type "shaded.org.eclipse.jdt.core.problem"). </li>
 ...
 * marker type.
 * Standard Java problem markers (i.e. marker type is "shaded.org.eclipse.jdt.core.problem") carry an
 ...
 * Standard Java problems are associated to marker type "shaded.org.eclipse.jdt.core.problem").
...
public String[] getExtraMarkerAttributeNames() {
	return DOMConstants.NO_STRINGS;
}
