 ...
 * (see {@link shaded.org.eclipse.jdt.core.dom.ASTNode ASTNode} and its subclasses)
 ...
 * </pre>
 * <p>
 * See also {@link shaded.org.eclipse.jdt.core.dom.rewrite.ASTRewrite} for
...
public final class AST {
	 ...
	 * @deprecated Use shaded.org.eclipse.jdt.core.dom.AST.convertCompilationUnit(int, CompilationUnitDeclaration, Map, boolean, CompilationUnit, int, IProgressMonitor) instead
...
//	}
	 ...
	 * <ul>
	 * <li><code>"shaded.org.eclipse.jdt.core.compiler.source"</code>
	 ...
	 *    </ul>
	 * </li>
	 * <li><code>"shaded.org.eclipse.jdt.core.compiler.problem.enablePreviewFeatures"</code> -
