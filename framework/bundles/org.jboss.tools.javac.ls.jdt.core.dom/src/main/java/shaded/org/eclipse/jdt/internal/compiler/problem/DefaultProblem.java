...
public class DefaultProblem extends CategorizedProblem {
	...
	private static final String MARKER_TYPE_PROBLEM = "shaded.org.eclipse.jdt.core.problem"; //$NON-NLS-1$
	private static final String MARKER_TYPE_TASK = "shaded.org.eclipse.jdt.core.task"; //$NON-NLS-1$
...
/**
 * @see shaded.org.eclipse.jdt.core.compiler.CategorizedProblem#getCategoryID()
 */
@Override
 ...
 * @see shaded.org.eclipse.jdt.core.compiler.IProblem#getID()
 * @return int
 */
@Override
public int getID() {
 ...
 * @see shaded.org.eclipse.jdt.core.compiler.CategorizedProblem#getMarkerType()
 */
@Override
