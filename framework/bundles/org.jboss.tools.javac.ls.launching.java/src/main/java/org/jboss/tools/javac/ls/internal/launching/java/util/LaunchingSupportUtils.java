 ...
 ******************************************************************************/
package org.jboss.tools.javac.ls.internal.launching.java.util;
...
import org.jboss.tools.javac.ls.eclipse.debug.core.DebugException;
import org.jboss.tools.javac.ls.eclipse.debug.core.Launch;
import org.jboss.tools.javac.ls.eclipse.debug.core.model.IProcess;
import org.jboss.tools.javac.ls.eclipse.debug.core.model.IStreamsProxy;
import org.jboss.tools.javac.ls.eclipse.jdt.internal.launching.LibraryInfo;
import org.jboss.tools.javac.ls.eclipse.jdt.launching.IJavaLaunchConfigurationConstants;
import org.jboss.tools.javac.ls.eclipse.jdt.launching.IVMInstallChangedListener;
import org.jboss.tools.javac.ls.eclipse.jdt.launching.IVMRunner;
import org.jboss.tools.javac.ls.eclipse.jdt.launching.VMRunnerConfiguration;
import org.jboss.tools.javac.ls.eclipse.osgi.util.NLS;
import org.jboss.tools.javac.ls.launching.utils.ExecUtil;
import org.jboss.tools.javac.ls.launching.utils.NativeEnvironmentUtils;
import org.jboss.tools.javac.ls.launching.utils.OSUtils;
	...
	public File getLaunchingSupportFile() {
		...
		if( destination == null ) {
			...
			if( !destination.exists() || destination.length() <= 0 ) {
				...
				if( is == null ) {
					String url = "https://raw.githubusercontent.com/redhat-developer/rsp-server/v0_26_2/framework/bundles/org.jboss.tools.javac.ls.launching.java/src/main/resources/launchingsupport.jar";
					try {
