 ...
 ******************************************************************************/
package org.jboss.tools.javac.ls.logging;


import org.jboss.tools.javac.ls.eclipse.osgi.util.NLS;
import org.jboss.tools.javac.ls.logging.internal.OSGILogReaderInitializer;
...
public class LoggingActivator implements BundleActivator, LoggingConstants {
	...
	private static final String BUNDLE_ID = "org.jboss.tools.javac.ls.logging";
