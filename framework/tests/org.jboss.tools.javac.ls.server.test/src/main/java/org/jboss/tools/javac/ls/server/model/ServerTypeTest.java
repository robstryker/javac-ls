...
import org.jboss.tools.javac.ls.api.dao.CreateServerWorkflowRequest;
import org.jboss.tools.javac.ls.api.dao.ServerLaunchMode;
...
import org.jboss.tools.javac.ls.launching.internal.LaunchingActivator;
import org.jboss.tools.javac.ls.launching.java.ILaunchModes;
...
public class ServerTypeTest {
	...
	private class TestType implements IServerType {
		...
		@Override
		public WorkflowResponse createServerWorkflow(JavacLSServer server, CreateServerWorkflowRequest req) {
			return null;
		}
