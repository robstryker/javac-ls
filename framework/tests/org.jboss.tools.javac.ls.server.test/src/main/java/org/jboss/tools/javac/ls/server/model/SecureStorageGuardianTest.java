...
import org.jboss.tools.javac.ls.api.ICapabilityKeys;
import org.jboss.tools.javac.ls.api.JavacLSClient;
import org.jboss.tools.javac.ls.api.dao.ClientCapabilitiesRequest;
import org.jboss.tools.javac.ls.secure.model.ISecureStorageProvider;
import org.jboss.tools.javac.ls.server.persistence.DataLocationCore;
import org.jboss.tools.javac.ls.server.spi.client.ClientThreadLocal;
...
public class SecureStorageGuardianTest {
	...
	public void testSecureStorageGuardian() throws IOException {
		JavacLSClient client = mock(JavacLSClient.class);
	...
	public void testGuardianSecondClientWrongPassword() throws IOException {
		...
		JavacLSClient client2 = mock(JavacLSClient.class);
	...
	private void testPromptableGuardian(ServerManagementModel model, JavacLSClient client, boolean validPassword) {
